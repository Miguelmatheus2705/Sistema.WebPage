...
import { db } from '../Banco de dados/database.js';
...
export function renderTable() {
  ...
  if (!data.length) {
    body.innerHTML = `<tr class="empty-row"><td colspan="4">Nenhum cliente cadastrado ainda.</td></tr>`;
    return;
  }
...
export function handleSubmit() {
  ...
  setTimeout(() => openWhatsApp(nome, telefone), 900);
}
